...
public final class PhoneNumberFactory extends RandomNumberFactory {
    ...
    RandomNumberFactory temp = new PhoneNumberFactory();
    ...
    public static PhoneNumber[] createRandomPhoneNumberArray(int phoneNumberCount) throws InvalidPhoneNumberFormatException {
            ...
            PhoneNumber[] answer = new PhoneNumber[phoneNumberCount-1];
        for (int i = 0; i <phoneNumberCount ; i++) {

            answer[i] = createRandomPhoneNumber();
    ...
    public static PhoneNumber createRandomPhoneNumber() {
        ...
        Integer areaCode = RandomNumberFactory.createInteger(200,900);
        Integer centralOfficeCode = RandomNumberFactory.createInteger(200,900);
        Integer phoneLineCode = RandomNumberFactory.createInteger(1000,9000);
